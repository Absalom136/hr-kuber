...
export default function Topbar({ userName = 'Ella Jones', avatarUrl, onToggleSidebar }) {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-6 py-3 flex justify-between items-center shadow-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
          ...
          <span className="font-medium">
            Home &gt; {location.pathname.split('/').pop()}
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 relative">
        <DarkModeToggle /> {/* ✅ Dark mode toggle added before fullscreen */}
        ...
        {notifOpen && (
          <div className="absolute right-12 top-12 w-64 bg-white dark:bg-gray-800 rounded shadow-lg z-50">
